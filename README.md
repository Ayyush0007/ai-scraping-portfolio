...
### ⭐ Day 4 — Review Sentiment Analyzer
...
python3 day1_job_scraper/job_pipeline.py
python3 day2_news_scraper/news_scraper.py
python3 day3_price_tracker/price_tracker.py
python3 day4_review_analyzer/review_analyzer.py
```
